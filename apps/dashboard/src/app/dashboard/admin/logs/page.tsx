...
export default function AdminLogsPage() {
  ...
  const getLevelBadgeTone = (level: string): BadgeTone => {
    return LEVEL_TONES[level] ?? LEVEL_TONES.debug;
  };
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            <label className="flex items-center gap-2 cursor-pointer">
              <input
                ...
                className="size-4 rounded border-[var(--surface-border)] bg-[var(--surface-base)] text-[var(--text-primary)] focus:ring-2 focus:ring-[var(--text-primary)]/20 focus:ring-offset-0"
              />
                ...
                {pagedLogs.map((log, index) => {
                  ...
                  <React.Fragment key={`log-${log.time}-${globalIndex}`}>
                    ...
                    >
                      ...
                      <td className="px-3 py-2">
                        <Badge
                          tone={getLevelBadgeTone(log.levelLabel)}
