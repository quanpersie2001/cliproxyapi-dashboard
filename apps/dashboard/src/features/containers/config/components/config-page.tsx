...
import AgentConfigEditor from "@/features/containers/config/components/agent-config-editor";
import ConfigPreview from "@/features/containers/config/components/config-preview";
...
import type { RoutingStrategy } from "@/features/containers/config/types";
import type {
  AmpcodeConfig,
  ...
  StreamingConfig,
  TlsConfig,
} from "@/features/containers/config/types";
