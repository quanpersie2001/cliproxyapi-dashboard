...
import { LiveLogs } from "@/features/monitoring/components/live-logs";
import { ServiceStatus } from "@/features/monitoring/components/service-status";
import { ConfirmDialog } from "@/components/ui/confirm-dialog";
import { API_ENDPOINTS } from "@/lib/api-endpoints";

const UsageStats = dynamic(
  () => import("@/features/monitoring/components/usage-stats").then(mod => ({ default: mod.UsageStats })),
