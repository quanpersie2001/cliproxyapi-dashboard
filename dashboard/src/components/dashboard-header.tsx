    ...
    <header className="w-full bg-[var(--surface-base)] border-b border-[var(--surface-border)] py-2.5 px-4 lg:px-6 rounded-2xl mb-4 shadow-[var(--shadow-card)] flex items-center justify-between">
      ...
      <div className="flex items-center gap-2">
        ...
        >
          ...
          <div className="w-9 h-9 rounded-full bg-[var(--surface-muted)] border border-[var(--surface-border)] flex items-center justify-center text-sm font-medium text-[var(--text-primary)] group-hover:border-[var(--surface-border-strong)] group-hover:shadow-[var(--shadow-warm)] transition-[color,border-color,box-shadow]">
            {initial}
          </div>
        </button>
      </div>
