...
const NAV_ITEMS = [
  { href: "/dashboard", label: "Overview", icon: IconPlayCircle, adminOnly: false, section: "general" },
  ...
  { href: "/dashboard/config", label: "Proxy Settings", icon: IconFileCode, adminOnly: true, section: "admin" },
