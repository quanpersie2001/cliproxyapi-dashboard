...
function getLatencyTone(latencyMs: number): BadgeTone {
  if (latencyMs <= 0) return "neutral";
          ...
          <tbody>
            {pagedEvents.map((event, index) => (
              ...
              >
                ...
                <td className="px-3 py-2">
                  <Badge
                    tone={event.failed ? "danger" : "success"}
                    size="xs"
                ...
                <td className="px-3 py-2 text-right">
                  <Badge
                    tone={getLatencyTone(event.latencyMs)}
                    className="px-2 py-0.5 text-[11px] font-semibold tabular-nums"
                  >
