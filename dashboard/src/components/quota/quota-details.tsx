          ...
          return (
            <div key={account.auth_index} className="border-b border-[var(--surface-border)] last:border-b-0">
              <button
                ...
                className="grid w-full grid-cols-[24px_minmax(0,1fr)_120px_120px_140px_140px] items-center px-3 py-2 text-left transition-colors hover:bg-[var(--surface-muted)]"
              >
