              ...
              {updateInfo.availableVersions && updateInfo.availableVersions.length > 1 && (
                <div>
                  ...
                  <select
                    ...
                    className="w-full rounded-lg bg-[var(--surface-muted)] border border-[var(--surface-border)] text-[var(--text-primary)] text-sm px-3 py-2 outline-none focus:border-[var(--surface-border-strong)] transition-colors"
                  >
