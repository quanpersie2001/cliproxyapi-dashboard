    ...
    <ModalTitleIdContext.Provider value={titleId}>
      ...
      >
        ...
        <div
          ref={modalRef}
          className={cn(
            "animate-modal-card relative z-10 max-h-[90vh] w-full max-w-2xl overflow-y-auto bg-[var(--surface-base)] border-none rounded-2xl p-5 shadow-[var(--shadow-card)]",
            className
          )}
        ...
        >
          <button
            type="button"
            onClick={onClose}
            className="absolute right-3 top-3 rounded-md p-1 text-[var(--text-muted)] hover:text-[var(--text-primary)] hover:bg-[var(--surface-muted)] transition-colors"
            aria-label="Close"
          >
