        ...
        <div className="flex flex-col h-full p-6">
          ...
          <div className="mb-4">
            <button
              ...
              className="flex w-full items-center justify-between rounded-md px-3 py-2 text-sm font-semibold text-[var(--text-primary)] hover:bg-[var(--surface-muted)] transition-colors"
            >
              <div className="flex items-center gap-2">
            ...
            >
              <form onSubmit={handlePasswordChange} className="space-y-3 px-3">
                ...
                {/* Feedback */}
                {error && (
                  <AlertSurface role="alert" aria-live="polite" tone="danger" className="px-3 py-2 text-xs">
                    {error}
                  </AlertSurface>
                )}

                {success && (
                  <AlertSurface role="status" aria-live="polite" tone="success" className="px-3 py-2 text-xs">
          ...
          <button
            ...
            className="flex w-full items-center gap-2 rounded-md px-3 py-2 text-sm font-medium text-[var(--text-secondary)] hover:bg-[var(--surface-muted)] hover:text-[var(--text-primary)] transition-colors"
          >
            <svg className="w-4 h-4 text-[var(--text-muted)]" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24" aria-hidden="true">
